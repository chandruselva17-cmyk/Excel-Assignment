...
○ If Price ≥ $500 → classify as High Price
...
● Use the SUMIF function to calculate the total price of products in the
Electronics category.

● Use the COUNTIF function to determine the number of products with a price
less than $100.
